  ...
  function bindActionToElem(event, elem, prop) {
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        ...
        Object(_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(prop, state);
      });
    });
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var closeModal = function closeModal(classes) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        Object(_closeModal__WEBPACK_IMPORTED_MODULE_6__["default"])('.popup_calc_end', 3000);
      });
    });
  });
};
...
var modals = function modals() {
  ...
  var modalState = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
